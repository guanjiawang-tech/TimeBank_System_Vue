<template>
   <div class='administratorManagePage'>
        ...
        <el-table :data="tableData" height="670" style="width: 100%">
            ...
            <el-table-column label="设置" align="center">
               <template #default="scope">
                  <el-button type="primary" size="mini" @click="updateSettings(scope.row)">修改密码</el-button>
                  <el-button type="danger" size="mini" @click="deleteSettings(scope.row)">删除账户</el-button>
               </template>
            </el-table-column>
         </el-table>
   </div>
...
function deleteSettings(res){
   ...
   ElMessageBox.confirm(
    ...
    .then(() => {
      axios.post('http://localhost:8080/users/deleteById',{
         userId:res.userId,
      })
      .then((res)=>{
         tableData.splice(tableData.length = 0)
